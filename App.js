...
export default function App() {
  ...
  async function converter() {
    ...
    //USD-BRL ele devolve quanto é 1 dólar convertido para reais
    ...
    //Comando que fecha o teclado, caso esteja aberto
    Keyboard.dismiss();
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.areaValor}>
          <Text style={styles.titulo}>Digite um valor ára converter em (R$)</Text>
